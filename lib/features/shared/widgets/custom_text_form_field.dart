    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorBorder: border.copyWith( borderSide: const BorderSide( color: Color(0xFFFDD2D2) )),
          focusedErrorBorder: border.copyWith( borderSide: const BorderSide( color: Color.fromARGB(255, 247, 156, 156) )),
          isDense: true,
